"""
Rotowire Retriever — predicted lineups, injury analysis, start/sit recommendations.

Uses Tavily/Exa search with rotowire.com domain filtering.
"""
...
ROTOWIRE_SEARCH_DOMAINS = ["rotowire.com"]


class RotowireRetriever(BaseRetriever):
    def __init__(self, cache=None, search_service=None):
        super().__init__(
            source_name="rotowire",
            source_tier=get_source_tier("rotowire"),
    ...
    async def _do_fetch(
        ...
        include_domains = params.get("include_domains", ROTOWIRE_SEARCH_DOMAINS)
