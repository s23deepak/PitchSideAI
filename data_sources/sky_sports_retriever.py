"""
Sky Sports Retriever — team news, press conferences, match previews.

Uses Tavily/Exa search with skysports.com domain filtering.
"""
...
SKY_SPORTS_SEARCH_DOMAINS = ["skysports.com"]


class SkySportsRetriever(BaseRetriever):
    def __init__(self, cache=None, search_service=None):
        super().__init__(
            source_name="sky_sports",
            source_tier=get_source_tier("sky_sports"),
    ...
    async def _do_fetch(
        ...
        include_domains = params.get("include_domains", SKY_SPORTS_SEARCH_DOMAINS)
