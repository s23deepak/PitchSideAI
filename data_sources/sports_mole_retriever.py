"""
Sports Mole Retriever — predicted XIs, form guides, match previews.

Uses Tavily/Exa search with sportsmole.co.uk domain filtering.
"""
...
SPORTS_MOLE_SEARCH_DOMAINS = ["sportsmole.co.uk"]


class SportsMoleRetriever(BaseRetriever):
    def __init__(self, cache=None, search_service=None):
        super().__init__(
            source_name="sports_mole",
            source_tier=get_source_tier("sports_mole"),
    ...
    async def _do_fetch(
        ...
        include_domains = params.get("include_domains", SPORTS_MOLE_SEARCH_DOMAINS)
