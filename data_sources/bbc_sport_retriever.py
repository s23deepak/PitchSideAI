"""
BBC Sport Retriever — match previews, gossip column, team news.

Uses Tavily/Exa search with bbc.com/sport domain filtering.
"""
...
BBC_SPORT_SEARCH_DOMAINS = ["bbc.com", "bbc.co.uk"]


class BbcSportRetriever(BaseRetriever):
    def __init__(self, cache=None, search_service=None):
        super().__init__(
            source_name="bbc_sport",
            source_tier=get_source_tier("bbc_sport"),
    ...
    async def _do_fetch(
        ...
        include_domains = params.get("include_domains", BBC_SPORT_SEARCH_DOMAINS)
